...
const Project = (props) => {
    ...
    {isOpen && <div className={`${isActive ? 'project-in' : 'project-out'} opacity-90 project-info p-10 bg-slate-200  min-w-xl max-w-xl items-center`}>
        ...
        <Link href="google.com"><button className="bg-cyan-400 p-2 pr-4 pl-4 rounded-xl hover:bg-cyan-500 active:scale-95">Live Site</button></Link>
        <Link href="google.com"><Image src="/github.svg" width={40} height={40} className="cursor-pointer active:scale-95"/></Link>
        </div>
    </div>}
        </div>
    </>
