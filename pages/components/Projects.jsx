      ...
      <div className=" mb-9 grid-container grid justify-center mt-24 gap-20">
        ...
        <div>
          <Project
            ...
            Each level displays 10 images at a time from a set of 20. After each player click the 10 images are randomly chosen from the set of 20. I buil this using React and a the free rick and morty api."
          />
        </div>
        <div>
          <Project
