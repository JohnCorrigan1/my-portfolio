            ...
            <div className='flex  gap-10 w-2/3 justify-center bg-slate-100 p-5 shadow-lg drop-shadow-lg'>
                ...
                <div className='flex flex-col'>
                    ...
                    <div className='flex gap-5 mt-auto justify-center items-center'>
                        <a href="https://www.linkedin.com/in/john-corrigan322/"><Image className="cursor-pointer" src={Linkedln} height={40} width={40} alt="Linkeldn icon"/></a>
                        <a href="https://github.com/JohnCorrigan1"><Image className="cursor-pointer" src={Github} height={40} width={40} alt="Github icon"/></a>
