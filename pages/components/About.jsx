    ...
    <div className="flex justify-center mt-10">
      <div className="flex container gap-10 w-2/3 justify-center bg-slate-100 p-5 shadow-lg drop-shadow-lg">
        ...
        <div className="flex flex-col">
          <p>
            I am currently focuses on learning all things web development.
            Outside of code I like to play video games, fish, and work at job
            epic gamer alert. This is not a picture of John Corrigan this was
            generated by ai
          </p>
          <p className="mb-5">
            John Corrigan John Corrigan John Corrigan John Corrigan John
            Corrigan
          </p>
